...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath="vgg_hf/splitted/epoch_{epoch}.h5"),
    tf.keras.callbacks.CSVLogger("vgg_hf/splitted/faces_ft1.log", separator=",", append=False),
