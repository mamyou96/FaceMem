...
# Function that yields random samples of10k us face database
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath="senet_hf/drop/epoch_{epoch}.h5"),
    tf.keras.callbacks.CSVLogger("senet_hf/drop/faces_ft1.log", separator=",", append=False),
