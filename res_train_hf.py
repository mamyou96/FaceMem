...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath="res_hf/splitted/epoch_{epoch}.h5"),
    tf.keras.callbacks.CSVLogger("res_hf/splitted/faces_ft.log", separator=",", append=False),
